...
define( 'YOURLS_DB_USER', 'db72149_justin' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', 'Pr0spect' );

/** The name of the database for YOURLS */
define( 'YOURLS_DB_NAME', 'db72149_shortenerjlc' );

/** MySQL hostname.
 ** If using a non standard port, specify it like 'hostname:port', eg. 'localhost:9999' or '127.0.0.1:666' */
define( 'YOURLS_DB_HOST', 'external-db.s72149.gridserver.com' );

/** MySQL tables prefix */
define( 'YOURLS_DB_PREFIX', 'shorts_' );
...
define( 'YOURLS_SITE', 'http://jlc.ninja' );
